...
impl<I: ImageSize> Sprite<I> {
    ...
    pub fn from_texture(texture: Arc<I>) -> Sprite<I> {
        Sprite {
            id: Uuid::new_v4(),
    ...
    pub fn from_texture_rect(texture: Arc<I>, src_rect: SourceRectangle) -> Sprite<I> {
        Sprite {
            id: Uuid::new_v4(),
    ...
    #[inline(always)]
    pub fn get_texture(&self) -> &Arc<I> {
        &self.texture
    }

    /// Set the sprite's texture
    #[inline(always)]
    pub fn set_texture(&mut self, texture: Arc<I>) {
...
impl Sprite<Texture> {
    pub fn from_texture_data(texture_data: TextureData) -> Sprite<Texture> {
        let mut sprite = Sprite::from_texture_rect(texture_data.texture, texture_data.src_rect);
        sprite.set_anchor(0.0, 0.0);
        sprite
    }

    pub fn update_texture_data(&mut self, texture_data: TextureData) {
